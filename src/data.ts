...
export const tasks: Task[] = [
  { id:'T001', module:'SymOS', gate:'G0', title:'Kick-off e Project Charter', owner:'Patrick Tanaka', support:'Aky + P&D + Reg. + Qualidade', start:'07/09/2026', due:'09/09/2026', status:'Não iniciado', priority:'Crítica', progress:0, plannedHours:4, actualHours:0, evidence:'Project Charter', nextAction:'Validar escopo, targets e governança' },
  ...
  { id:'T011', module:'SymOS', gate:'G5+', title:'Change Control após Formula Lock', owner:'Patrick Tanaka', support:'Todos', start:'24/10/2026', due:'16/11/2026', status:'Não iniciado', priority:'Alta', progress:0, plannedHours:4, actualHours:0, dependency:'T010', evidence:'Change Request Log', nextAction:'Registrar mudanças relevantes' },
  ...
  { id:'T016', module:'SymOS', gate:'G7', title:'Encerramento + lições aprendidas', owner:'Patrick Tanaka', support:'Todos', start:'16/11/2026', due:'19/11/2026', status:'Não iniciado', priority:'Média', progress:0, plannedHours:6, actualHours:0, dependency:'T015', evidence:'Close-out + Lessons Learned', nextAction:'Encerrar projeto' },
]
